...
import type { HoverHandlers, MotionValue, TapHandlers, ResolvedValues, AnimationLifecycles, AnimationProps } from "framer-motion";
...
export type AcceptMotionValues<T> = Omit<T, "position" | "scale" | "rotation" | "color"> & {
