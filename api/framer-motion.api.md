...
export class AnimationControls {
    ...
    stop(): void
    // Warning: (ae-forgotten-export) The symbol "VisualElementAnimationControls" needs to be exported by the entry point index.d.ts
    //
    // @internal
...
export const SharedLayoutContext: import("react").Context<
    SharedBatchTree | SharedLayoutTree
>
