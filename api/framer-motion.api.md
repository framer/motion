...
export function animate<V>(
    ...
    to: V | V[],
    transition?: AnimationOptions_2<V>
): PlaybackControls
...
export class AnimateSharedLayout extends React.Component<SharedLayoutProps> {
    ...
    static contextType: React.Context<
        import("../../motion/context/MotionContext").MotionContextProps
    >
...
> extends VisualElement<E> {
    ...
    // (undocumented)
    rebaseProjectionTarget(force?: boolean, box?: AxisBox2D): void
...
// @public (undocumented)
export const m: import("./types").HTMLMotionComponents &
    import("./types").SVGMotionComponents & {
        custom: <Props>(
            Component:
                | string
                | import("react").ComponentClass<Props, any>
                | import("react").FunctionComponent<Props>
        ) => import(".").CustomDomComponent<Props>
    }
