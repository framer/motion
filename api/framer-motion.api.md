...
// Warning: (ae-forgotten-export) The symbol "BatchUpdate" needs to be exported by the entry point index.d.ts
// Warning: (ae-forgotten-export) The symbol "MagicContextUtils" needs to be exported by the entry point index.d.ts
...
// 
// @internal (undocumented)
export const MagicContext: import("react").Context<BatchUpdate | MagicContextUtils>;
