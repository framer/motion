...
// Warning: (ae-forgotten-export) The symbol "SharedMagicTree" needs to be exported by the entry point index.d.ts
...
export const MagicContext: import("react").Context<
    MagicBatchTree | SharedMagicTree
>

// Warning: (ae-forgotten-export) The symbol "SharedMagicMotionProps" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
