...
export function addScaleCorrection(
...
>): React.ForwardRefExoticComponent<
    React.PropsWithoutRef<Props & MotionProps> & React.RefAttributes<Instance>
>
...
//
// @internal (undocumented)
export const FramerTreeLayoutContext: import("react").Context<
...
export const m: (<Props>(
    Component: string | import("react").ComponentType<Props>,
    customMotionComponentConfig?: import("./motion-proxy").CustomMotionComponentConfig
) => import("./motion-proxy").CustomDomComponent<Props>) &
    import("../html/types").HTMLMotionComponents &
    import("../svg/types").SVGMotionComponents
...
// @public
export type TransformPoint = (point: Point2D) => Point2D
...
//
// @internal @deprecated
export function useDeprecatedInvertedScale(
