...
// 
// @internal (undocumented)
export const MagicContext: import("react").Context<MagicBatchTree | SharedMagicTree>;
...
// 
// @public (undocumented)
export class SharedMagicMotion extends React.Component<SharedMagicMotionProps, SharedMagicTree> {
    ...
    shouldComponentUpdate(nextProps: SharedMagicMotionProps, nextState: SharedMagicTree): boolean;
    // (undocumented)
    state: {
        forceRender: () => void;
...
// 
// types/motion/features/magic/SharedMagicMotion.d.ts:50:9 - (ae-forgotten-export) The symbol "Magic" needs to be exported by the entry point index.d.ts
