 ...
 * @internal
 */
export const VisualElementContext = React.createContext<
    VisualElement | undefined
>(undefined)

export function useVisualElementContext() {}

// TODO: Pass variants through VisualElement?
...
// TODO: This is used to trigger stagger reordering when variants change
//             animateDependency,
//             presenceId,
//         ]
//     )
