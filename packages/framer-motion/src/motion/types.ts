...
export interface MotionProps
    ...
    /**
     * By default, Motion One generates a `transform` property with a sensible transform order. `transformTemplate`
     ...
     * @param generatedTransform - The transform string as automatically generated by Motion One
     *
     * @public
     */
    transformTemplate?(
