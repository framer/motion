...
function runTests(render: (components: any) => string) {
    ...
    test("Reorder: Renders correct element", () => {
        ...
        expect(div).toBe(
            `<ul><li style="z-index:unset;transform:none;-webkit-touch-callout:none;-webkit-user-select:none;user-select:none;touch-action:pan-y" draggable="false"></li></ul>`
        )
    })
    ...
    test("Reorder: Renders provided element", () => {
        ...
        expect(div).toBe(
            `<div><div style="z-index:unset;transform:none;-webkit-touch-callout:none;-webkit-user-select:none;user-select:none;touch-action:pan-y" draggable="false"></div></div>`
        )
    })
}
