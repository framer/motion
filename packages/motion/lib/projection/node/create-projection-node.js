...
import { calcBoxDelta, calcLength, calcRelativeBox, calcRelativePosition, } from "../geometry/delta-calc";
 ...
 */
export var globalProjectionState = {
    /**
...
export function createProjectionNode(_a) {
