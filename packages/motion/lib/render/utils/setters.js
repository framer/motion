...
export function setTarget(visualElement, definition) {
    ...
    var _a = resolved ? visualElement.makeTargetAnimatable(resolved, false) : {}, _b = _a.transitionEnd, transitionEnd = _b === void 0 ? {} : _b, _c = _a.transition, transition = _c === void 0 ? {} : _c, target = __rest(_a, ["transitionEnd", "transition"]);
...
export function setValues(visualElement, definition) {
...
export function checkTargetForNewValues(visualElement, target, origin) {
    var _a, _b, _c;
    var _d;
...
export function getOriginFromTransition(key, transition) {
    if (!transition)
        return;
    var valueTransition = transition[key] || transition["default"] || transition;
    return valueTransition.from;
}
export function getOrigin(target, transition, visualElement) {
    var _a, _b;
    var origin = {};
    for (var key in target) {
        origin[key] =
