 ...
 */
export function isTransitionDefined(_a) {
 ...
 */
export function convertTransitionToAnimationOptions(_a) {
 ...
 */
export function getDelayFromTransition(transition, key) {
    var _a, _b;
    var valueTransition = getValueTransition(transition, key) || {};
    return (_b = (_a = valueTransition.delay) !== null && _a !== void 0 ? _a : transition.delay) !== null && _b !== void 0 ? _b : 0;
}
export function hydrateKeyframes(options) {
...
export function getPopmotionAnimationOptions(transition, options, key) {
    var _a;
...
export function getZeroUnit(potentialUnitType) {
 ...
 * @internal
 */
export function startAnimation(key, value, target, transition) {
