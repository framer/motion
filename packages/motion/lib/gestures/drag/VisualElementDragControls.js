...
import { PanSession } from "../../gestures/PanSession";
import { getGlobalLock } from "./utils/lock";
import { isRefObject } from "../../utils/is-ref-object";
import { addPointerEvent } from "../../events/use-pointer-event";
import { calcRelativeConstraints, calcViewportConstraints, applyConstraints, rebaseAxisConstraints, resolveDragElastic, defaultElastic, calcOrigin, } from "./utils/constraints";
...
export var elementDragControls = new WeakMap();
/**
 *
 */
...
export function expectsResolvedDragConstraints(_a) {
    var dragConstraints = _a.dragConstraints, onMeasureDragConstraints = _a.onMeasureDragConstraints;
